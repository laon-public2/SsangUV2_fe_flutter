...
final String SERVER_ADDRESS = "115.91.73.66"; //실서버
//final String SERVER_ADDRESS = "192.168.100.232"; //개발서버
final String chat_address = "115.91.73.66"; //채팅은 실서버에서만 동작합니다.

// final String SERVERURL = "http://${SERVER_ADDRESS}:15000/api"; //실서버
final String SERVERURL = "http://${SERVER_ADDRESS}:15000/api"; //개발서버
