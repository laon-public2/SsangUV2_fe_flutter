          ...
          itemBuilder: (context, idx) {
            if (this._currentItem == "빌려드려요") {
              return LendItemMainPage(
                category: "${_category(productController.searchDataProductCa10[idx].category)}",
                ...
                price: "${_moneyFormat("${productController.searchDataProductCa10[idx].price}")}원",
                distance:
                "${(productController.searchDataProductCa10[idx].distance).toStringAsFixed(2)}",
                picture: "${productController.searchDataProductCa10[idx].productFiles[0].path}",
              );
            } else {
              return WantItemMainPage(
                ...
                startDate: _dateFormat(productController.searchDataProductWantCa10[idx].startDate),
                endDate: _dateFormat(productController.searchDataProductWantCa10[idx].endDate),
                picture: productController.searchDataProductWantCa10[idx].productFiles[0].path,
              );
            }
          },
