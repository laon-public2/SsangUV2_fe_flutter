              ...
              itemBuilder: (context, idx) {
                if (_currentItem == "빌려드려요") {
                  return LendItemMyAct(
                    ...
                    idx: _myActHistory.proRentCa9[idx].idx,
                    picFile: _myActHistory.proRentCa9[idx].image[0].file,
                    arrayNum: idx,
                  ...
                  return WantItemMyAct(
                    ...
                    minPrice: "${_moneyFormat("${_myActHistory.proWantCa9[idx].min_price}")}원",
                    maxPrice: "${_moneyFormat("${_myActHistory.proWantCa9[idx].max_price}")}원",
                    startDate: _dateFormat(_myActHistory.proWantCa9[idx].start_date),
                    endDate: _dateFormat(_myActHistory.proWantCa9[idx].end_date),
                    picture: _myActHistory.proWantCa9[idx].image[0].file,
                  );
                } else {
                  Navigator.push(
                    context,
