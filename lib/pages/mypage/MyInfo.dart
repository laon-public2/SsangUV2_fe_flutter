            ...
            child: Column(
              children: [
                InkWell(
                  ...
                  child: ListTile(
                    leading: myInfo.userProfileImg.value.length != 0
                        ? Hero(
                      tag: "MyProfileImg",
                      child: Container(
                        width: 50.w,
                    ...
                    title: Container(
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            myInfo.userType.value == "BUSINESS" ? "대여업체" : "",
                            style: TextStyle(
                    ...
                    subtitle: Text(
                      _numberFormat(myInfo.phNum.value),
                      style: TextStyle(
                        fontSize: 15,
                ...
                myInfo.comNum.value.length != 0
                  ...
                  subtitle: InkWell(
                    onTap: () {
                      _showDialog(context, "${myInfo.comIdentity}");
                    },
                    child: Text(
                      myInfo.comNum.value,
                      style: TextStyle(
                  ...
                  trailing: SizedBox(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => MyComModified(comName: myInfo.comIdentity.value, comNum: myInfo.comNum.value))
                        );
                      },
                    ),
                  ),
                    ...
                    children: <Widget>[
                      InkWell(
                        onTap: () async{
                          Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => RemoveAccount(phNum: myInfo.phNum.value))
                          );
                        },
                        child: Center(
                          child: Text(
